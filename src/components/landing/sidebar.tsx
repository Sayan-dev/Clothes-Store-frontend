...
interface props{
    ...
    handleSlider:(e:Event | React.SyntheticEvent<Element, Event>, value:number | number[])=>void;
}
export default function Sidebar(props:props) {
    ...
    return (
        <div className={classes.root}>
            <Grid container spacing={3} direction="column" className={classes.bar}>
                <Grid item className={classes.sectionBody}>
                    ...
                    />
                    <div>Range: {userState.slider.min} - {userState.slider.val}</div>
                </Grid>
                <Grid item className={classes.sectionBody}>
                    ...
                    <Grid item>
                        <FormControlLabel
                            control={<Checkbox onChange={()=>toggleCatagory("mens")} checked={userState.catagory.mens} />}
                            label="Men's Wear"
                        />
                    </Grid>
                    <Grid item>
                        <FormControlLabel
                            control={<Checkbox onChange={()=>toggleCatagory("womens")} checked={userState.catagory.womens}/>}
                            label="Ladies Wear"
                        />
                    </Grid>
                    <Grid item>
                        <FormControlLabel
                            control={<Checkbox onChange={()=>toggleCatagory("kids")} checked={userState.catagory.kids} />}
                            label="Kids Wear"
                        />
                    </Grid>
                </Grid>
