...
const CreateDress = (props) => {
    ...
    const addDressHandler=(uri)=>{
        fabric.Image.fromURL('https://cors-anywhere.herokuapp.com/'+uri, (img)=> {
    ...
    const saveFileHandler=()=>{
        ...
        scrnshotHandler(prev=>{prev=canvasObj});
    ...
    const saveImageHandler=async (event)=>{
        ...
        try {
            const response=await axios.post('http://localhost:3002/api/dress/uploadDress',
            {
                name:"My File new",
                image:dataURL,
            },
    ...
    return (
        <Fragment>
            ...
            <Modal
                ...
                footer={<Fragment><Button onClick={closePreviewHandler}>Cancel</Button> <Button onClick={saveImageHandler}>Save and Proceed</Button></Fragment>}
            >
            ...
            <Row xs={2} lg={3}>
                ...
                <Col xs={12} lg={5}>
                    <Images 
                        ...
                        clicked={(uri)=>addDressHandler(uri)}/>
                </Col>
